...
console.log(`The velociraptor ate a ${velociraptor.diet} diet.`);

// How long was a stegosaurus?
console.log(`The stegosaurus was ${stegosaurus.length}m long.`);

// What time period did tyrannosaurus live in?
console.log(`The tyrannosaurus lived durring the ${tyrannosaurus.period} period.`);
...
//
///// Stretch /////
const schools = (graduates, array) => {
  for (let i = 0; i < graduates.length; i++) {
    array.push((graduates[i].university));
  }
  return array.sort();
}
schools(graduates, universities);
